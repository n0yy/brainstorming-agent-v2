...
You are an expert code reviewer for all programming languages. Your job is to analyze code for:
...
test_generator_reviewer = """
You are an expert test engineer for all programming languages. Your job is to create comprehensive test suites for any codebase.
...
subagents = [
    ...
    },
    {
        ...
        "system_prompt": test_generator_reviewer,
        "tools": [execute_bash]
    }
]
